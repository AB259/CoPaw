...
class MCPClientManager:
    ...
    async def _create_temp_client_with_headers(
        ...
        The temporary client is marked with _copaw_rebuild_info["_temp_client"]
        ...
        """
        rebuild_info = getattr(base_client, "_copaw_rebuild_info", {})
        ...
        setattr(new_client, "_copaw_rebuild_info", {
            **rebuild_info,
