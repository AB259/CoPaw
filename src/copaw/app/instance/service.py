...
class InstanceService:
    ...
    async def create_instance(
        self, request: CreateInstanceRequest, operator: Optional[str] = None
    ) -> Instance:
    ...
    async def update_instance(
        self, instance_id: str, request: UpdateInstanceRequest, operator: Optional[str] = None
    ) -> Instance:
        """Update instance."""
    ...
    async def delete_instance(self, instance_id: str, operator: Optional[str] = None) -> bool:
        """Delete instance."""
        existing = await self.store.get_instance(instance_id)
        if not existing:
            raise ValueError(f"实例 {instance_id} 不存在")
    ...
    async def allocate_user(
        self, request: dict, operator: Optional[str] = None
    ) -> AllocateUserResponse:
        ...
        # Create allocation
        allocation = await self.store.create_allocation(
            user_id=user_id,
            source_id=source_id,
            instance_id=instance_id,
        )
        ...
        updated_instance = await self.store.get_instance_with_usage(instance_id)
        ...
        return AllocateUserResponse(
            ...
            source_id=source_id,
            instance_id=instance_id,
            instance_name=updated_instance.instance_name if updated_instance else None,
            instance_url=updated_instance.instance_url if updated_instance else None,
            message="分配成功",
        )

    async def migrate_user(
        self, request: MigrateUserRequest, operator: Optional[str] = None
    ) -> AllocateUserResponse:
        ...
        target_instance = await self.store.get_instance_with_usage(request.target_instance_id)
    ...
    async def delete_allocation(
        self, request: DeleteAllocationRequest, operator: Optional[str] = None
    ) -> bool:
