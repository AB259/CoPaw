...
from copaw.agents import react_agent, skills_manager
...
from copaw.utils.fs_text import SanitizedFsText
...
def test_sanitize_registered_skill_dirs_rewrites_prompt_only_path() -> None:
    ...
    react_agent.CoPawAgent._sanitize_registered_skill_dirs(toolkit)
